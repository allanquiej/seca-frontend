...
import type { ISREmpresaTrimestralRequest, ISREmpresaTrimestralResponse, RespuestaApi } from "../types/calculadoras";
...
const ISREmpresaTrimestralPage: React.FC = () => {
  ...
  const [resultado, setResultado] = useState<RespuestaApi<ISREmpresaTrimestralResponse> | null>(null);
  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto" }}>
      ...
      <p style={{ fontSize: "1.1rem", color: "#64748b", marginBottom: "2rem" }}>
        Estima el ISR trimestral de tu empresa para una mejor planificación fiscal.
      </p>
