...
import type { IndemnizacionRequest, IndemnizacionResponse, RespuestaApi } from "../types/calculadoras";
import { calcularIndemnizacion } from "../services/calculadorasService";
import { generateIndemnizacionPDF } from "../utils/pdfGenerator";

const IndemnizacionPage: React.FC = () => {
  ...
  const [resultado, setResultado] = useState<RespuestaApi<IndemnizacionResponse> | null>(null);

  const handleNumberChange =
    (field: "salarioMensual") => (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleDownloadPDF = () => {
    if (resultado && resultado.datos) {
      generateIndemnizacionPDF({
        ...form,
        montoIndemnizacion: resultado.datos.montoIndemnizacion,
  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto" }}>
      ...
      <p style={{ fontSize: "1.1rem", color: "#64748b", marginBottom: "2rem" }}>
        Calcula la indemnización correspondiente según el salario mensual y tiempo laborado.
      </p>
...
export default IndemnizacionPage;