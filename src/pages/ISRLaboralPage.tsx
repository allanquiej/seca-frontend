...
const ISRLaboralPage = () => {
  ...
  const handleChange = (field: keyof ISRAsalariadoRequest) => (e: any) => {
    const value = e.target.type === "number" ? parseFloat(e.target.value) : e.target.value;
    setForm((prev) => ({
      ...prev,
      [field]: e.target.type === "number" && isNaN(value) ? 0 : value,
    }));
  };

  const handleCheckboxChange = (field: keyof ISRAsalariadoRequest) => (e: any) => {
    setForm((prev) => ({
      ...prev,
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const res = await calcularISRAsalariado(form as any);
      setResultado(res);
    } catch (err: any) {
    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "1rem" }}>
      <div style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "1.1rem", color: "#64748b", lineHeight: 1.6 }}>
          Calcula el ISR según el <strong>Decreto 10-2012 (Ley ISR)</strong> - Formulario oficial SAT
        </p>
      </div>

      <div style={{ background: "#dbeafe", border: "2px solid #2252EC", borderRadius: "1rem", padding: "1.5rem", marginBottom: "2rem" }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
        ...
        <div style={{ background: "white", borderRadius: "1rem", padding: "2rem", boxShadow: "0 4px 20px rgba(0,0,0,0.08)" }}>
          ...
          <div>
            ...
            <input
              ...
              required
              style={{ width: "100%", padding: "0.75rem", borderRadius: "0.5rem", border: "2px solid #e2e8f0", fontSize: "1rem" }}
            />
        ...
        <div style={{ background: "white", borderRadius: "1rem", padding: "2rem", boxShadow: "0 4px 20px rgba(0,0,0,0.08)" }}>
          ...
          {form.numeroPatronos === 1 && (
            <>
              <div style={{ marginBottom: "1.5rem" }}>
                <label style={{ display: "flex", alignItems: "center", gap: "0.75rem", cursor: "pointer" }}>
                  <input
                    ...
                    style={{ width: "1.25rem", height: "1.25rem" }}
                  />
                  <span style={{ fontWeight: 600 }}>Sueldo igual durante 12 Meses</span>
                </label>
              </div>
              ...
              {form.sueldoIgualDurante12Meses ? (
                ...
                <>
                  <div style={{ background: "#fef3c7", border: "2px solid #f59e0b", borderRadius: "0.75rem", padding: "1rem", marginBottom: "1rem" }}>
                      ...
                      return (
                        <div key={mes}>
                          ...
                          <input
                            ...
                            style={{ width: "100%", padding: "0.5rem", borderRadius: "0.5rem", border: "2px solid #e2e8f0", fontSize: "0.9rem" }}
                          />
                        </div>
                      );
                    })}
          ...
          <div style={{ background: "#f0f9ff", borderRadius: "0.75rem", padding: "1.5rem", marginTop: "1.5rem" }}>
      ...
      {error && (
        <div style={{ background: "#fee2e2", border: "2px solid #ef4444", borderRadius: "1rem", padding: "1rem", marginTop: "1.5rem", color: "#991b1b" }}>
          <strong>Error:</strong> {error}
        </div>
      )}

      {resultado && resultado.datos && (
        <div style={{ background: "linear-gradient(135deg, #0E234F, #2252EC)", borderRadius: "1rem", padding: "2rem", color: "white", boxShadow: "0 10px 40px rgba(14,35,79,0.4)", marginTop: "2rem" }}>
